...
2.	Select Create a Lambda function and enter the name `AnalyticsS3ToRedshiftLoader`.
3. Select the Runtime value as `Node.js 4.3` (original recommendation was 'Node 0.10')
